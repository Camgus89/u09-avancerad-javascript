       ...
       { products.length >= 0 && (
          <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10">
            ...
            <ul className="flex flex-col divide-y divide-gray-700">
              ...
              {product.productInfo && product.productInfo.productName}
            </h3>
            <p className="text-sm">{product.productInfo && product.productInfo.flavor}</p>
          </div>
          <div className="text-right">
            <p className="text-lg font-semibold">{product.productInfo && product.productInfo.price}kr</p>
          </div>
                      </div>
            ...
            <div className="space-y-1 text-right">
              <p>
                Total amount:
                <span className="font-semibold">{/* Här kan du räkna ut det totala beloppet för alla produkter */}kr</span>
              </p>
            </div>
