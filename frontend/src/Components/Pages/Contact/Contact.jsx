              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0 pl-4">
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    <div className="bg-purple-400/20 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded  sm:h-[70px] sm:max-w-[70px]">
                      <svg
                        width="24"
                        height="26"
                        viewBox="0 0 24 26"
                  ...
                  <form>
                    ...
                    <div className="mb-6">
                      <textarea
                        ...
                        className="text-body-color border-[f0f0f0] focus:border-purple-900 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                      ></textarea>
                    </div>
                    <div>
                      <button
                        type="submit"
                        className="bg-purple-800 hover:bg-purple-500 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                        Skicka Meddelande
                      </button>
                    </div>
