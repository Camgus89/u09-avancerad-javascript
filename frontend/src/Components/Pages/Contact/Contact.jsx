              ...
              <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0 pl-4">
                  ...
                  <div class="mb-8 flex w-full max-w-[370px]">
                    <div class="bg-purple-400/20 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded  sm:h-[70px] sm:max-w-[70px]">
                      <svg
                        width="24"
                        height="26"
                        viewBox="0 0 24 26"
